        ...
        <Grid.Container>
            <Grid xs={1}>
                <Card style={{borderRadius:0, backgroundColor:'transparent', height:"500px"}} >
                    <Image src={Patio[0]} width="100%" style={{ marginTop:0}}  onMouseOver={() => {changeImage(0)}} ></Image>
                    <Spacer y={1}/>
                    <Image src={Patio[2]} width="100%" style={{ marginTop:0}} onMouseOver={() => {changeImage(2)}}></Image>
                    <Spacer y={1}/>
                    <Image src={Patio[3]} width="100%" style={{ marginTop:0}} onMouseOver={() => {changeImage(3)}} ></Image>
                    <Spacer y={1}/>
                    <Image src={Patio[4]} width="100%" style={{ marginTop:0}} onMouseOver={() => {changeImage(4)}} ></Image>
                    <Spacer y={1}/>
                    <Image src={Patio[5]} width="100%" style={{ marginTop:0}} onMouseOver={() => {changeImage(5)}} ></Image>
                </Card>
            </Grid>
            <Spacer y={1}/>
            <Grid>
                <Card style={{ height:"500px", width:'887px', borderRadius:0, border: "1px solid black"}} >
                    <Image src={Patio[image]} style={{ }}></Image>
                </Card>
            </Grid>
            <Spacer y={2}/>
            <Grid>
                <div style={{ left:"100px"}}>
                <h1 style={{color:"#c99f69", fontWeight:'lighter'}} >Patio</h1>
                </div>
                <Spacer y={5}/>
